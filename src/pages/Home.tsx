...
export const Home = () => {
  ...
  useEffect(() => {
    axiosClient.get(requests.requestPopular).then((response) => {
    ...
    <Helmet title="Home">
      <div className="relative pt-[50%]">
        <img
          ...
          className="absolute top-0 left-0  w-full h-[85%]"
        />
        <div className="absolute top-0 left-0 bg-gradient-to-r from-black w-full h-[85%]"></div>
